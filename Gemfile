...
if rails_master?
  ...
  gem "actionmailer", ">= 7.0.6", rails_version
  gem "actionpack", ">= 7.0.6", rails_version
  gem "actionview", rails_version
  gem "activemodel", rails_version
  gem "activerecord", rails_version
  gem "activesupport", rails_version
  gem "railties", ">= 7.0.6", rails_version
...
gem "rack-protection" , ">= 3.1.0" # security
...
group :test, :development do
  ...
  gem "rubocop-discourse", ">= 3.4.0", require: false
  gem "parallel_tests"
...
gem "rack-mini-profiler", ">= 3.1.1", require: ["enable_rails_patches"]
